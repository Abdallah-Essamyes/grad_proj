...
|INDEX|   ACTION|   PAYLOAD| Description| Reply Index|
|-----|   ------|   -------| ---------- | --------|
|  0| Request status array| (none)| STM reads all 20 servo status registers| index 1|
|  2|  Torque set | data[1]= 1: torqueON<br>data[1]=0: torqueOFF| BROADCAST torque state| None|
|  3|    Request torque array|(none) |STM reads all 20 servo torque registers| index 5|
