...
font_size         = 18
servo_widget_width = 115

# ─── JSON path ────────────────────────────────────────────────────────────────
_POSITIONS_JSON = os.path.join(os.path.dirname(__file__), "..", "Jsons", "servo_positions.json")
...
DEFAULT_Y_VALUES: dict[int, int] = {
    ...
    11: 260,  12: 345,  13: 435,  14: 525,  15: 510,
    16: 255,  17: 255,  18: 310,  19: 175,
...
X_SHIFT_GROUPS: list[list[int]] = [
    ...
    [18, 15], [12, 13, 14], [16], [17], [19], [101], [102], [103], [104],
]

Y_GROUPS: list[list[int]] = [
    [0, 3], [1, 4], [2, 5, 11], [6, 18], [7, 12],
